...
// The Animation in the bellow function has to many working components that causes a lagging in the application when clicking on the search button, an easier animation would be to just move the position of the search componenet from left to right, instead of triggering opacities and widths
    ...
    function searchHandler(){
        if(display==='none'){
            ...
            ani().then(
                ...
                setTimeout(()=>{
                    setWidth(prevState=>prevState+350)
                    
                },100),
                setTimeout(()=>{
                    setOpacity(prevState=>prevState+1)
                    // setWidth('200px')
                ...
                setOpacity(prevState=>prevState-0)
            }
            ani().then(
                setWidth(prevState=>prevState-350),
    ...
    return(
        ...
        <img alt="logo" style={{
            ...
            <button></button> */}
                <li className="nav-li">
                    <NavLink className="nav-link" to={'/'}><Home style={{
                        color:'black',
                        display:`${toggle}`
                        }} size={size}/>
                ...
                <li className="nav-li">
                    <button style={{
                        ...
                        border:'none',
                        cursor:'pointer'
                    }} onClick={()=>searchHandler()} className="nav-link" to={'/search'}><SearchIcon style={{
                        color:'black'
                        }} size={size}/>
                ...
                <li className="nav-li">
                    <NavLink className="nav-link" to={'/explore'}><Compass style={{
                        color:'black',
                        }} size={size}/>
                ...
                <li className="nav-li">
                    <NavLink className="nav-link" to={'/reels'}><Reels style={{
                        color:'black'
                        }} size={size}/>
                ...
                <li className="nav-li">
                    <NavLink className="nav-link" to={'/message'}><Message style={{
                        color:'black'
                        }} size={size}/>
                ...
                <li className="nav-li">
                    <button style={{
                        ...
                        border:'none',
                        cursor:'pointer'
                    }} onClick={()=>searchHandler()} className="nav-link" to={'/search'}><Heart style={{
                        color:'black'
                        }} size={size}/>
                ...
                <li className="nav-li">
                    <NavLink className="nav-link" to={'/search'}><Plus style={{
                        color:'black'
                        }} size={size}/>
                ...
                <li className="nav-li">
                    <NavLink className="nav-link" to={'/profile'}><ProfileIcon style={{
                        color:'black'
                        }} size={size}/>
